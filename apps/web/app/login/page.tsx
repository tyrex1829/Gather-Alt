...
function LoginForm() {
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
      ...
      <p className="mt-2 text-sm text-white/60">Welcome back to your office.</p>
      <form onSubmit={onSubmit} className="mt-6 space-y-4">
        ...
        <button className="w-full rounded-xl bg-white py-3 text-sm font-semibold text-black">Login</button>
      </form>
    </div>
  );
}
